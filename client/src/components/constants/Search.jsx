...
const Search = (props) => {
  ...
  const { lookingFor, setLookingFor } = useCarContext();
    ...
    <>
      <div className="searchInputWrapper">
        <input
          ...
          value={searchValue}
          onChange={(e) => {setSearchValue(e.target.value);setLookingFor(e.target.value);console.log("the input is",lookingFor);
          }}
          /* onKeyPress={handleKeyPress} */
        />
        <button onClick={
          ()=>{setLookingFor(searchValue);
            console.log("Value is sent to context");
          // window.location.replace('/CarModels');
        }
        }
      >
